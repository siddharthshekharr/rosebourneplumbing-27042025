        ...
        <div className="min-h-screen">
            ...
            <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                ...
                <div className="absolute inset-0 z-0">
                    <NextImage src="plumbing-website/services/bathroom-refurbishment/hero"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                            ...
                            <span className="text-sm font-medium text-white">Complete Bathroom Solutions</span>
                        </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                            ...
                            <div className="mt-2">
                                <span className="relative inline-block px-4">
                                    <span className="relative z-10">Refurbishment</span>
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Transform your bathroom into a modern, luxurious space. Expert design and installation services for your perfect bathroom renovation.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                                <div>
                                    ...
                                    <p className="text-gray-300">Get your free design consultation today</p>
                                </div>
                                <Link
                                    href="/contact"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-blue-50">
                                    <span className="text-sm font-medium text-blue-600">Full Service Renovation</span>
                                </div>
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        From concept to completion, we handle every aspect of your bathroom renovation. Our experienced team ensures a seamless transformation with attention to every detail.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative h-[600px] rounded-2xl overflow-hidden">
                                    <NextImage src="plumbing-website/services/bathroom-refurbishment/content"
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-medium text-blue-600 mb-1">Expert Design</p>
                                                    <h4 className="text-2xl font-bold text-gray-900">Luxury Finishes</h4>
                                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                                    ...
                                    <span className="text-sm font-medium text-blue-100">Design Consultation</span>
                                </div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                                    ...
                                    <div className="mt-2">
                                        <span className="relative inline-block px-4">
                                            <span className="relative z-10">Bathroom Today</span>
                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 -rotate-1 rounded"></div>
                                        </span>
                                    </div>
                                </h2>
                                ...
                                <p className="text-xl text-gray-300 mb-8">
                                    Create your dream bathroom with our expert design and installation team. Book your free consultation and start your transformation journey.
                                </p>

                                {/* Trust Badges */}
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {[
                                        { text: "Free Design Service", icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
                                        { text: "10 Year Warranty", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
                                    ].map((badge, index) => (
