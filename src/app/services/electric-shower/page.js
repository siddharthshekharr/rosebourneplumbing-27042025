...
export default function ElectricShowerPage() {
    return (
        <div className="min-h-screen">
            ...
            <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/images/services/electric-shower/hero.jpg"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                            ...
                            <span className="text-sm font-medium text-white">Expert Electric Shower Services</span>
                        </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                            ...
                            <div className="mt-2">
                                <span className="relative inline-block px-4">
                                    <span className="relative z-10">Replacement</span>
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Professional electric shower installation and replacement services. Expert fitting of all major brands with same-day service available.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Need a Replacement?</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-blue-50">
                                    <span className="text-sm font-medium text-blue-600">Professional Installation</span>
                                </div>

                                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                                    Expert Electric Shower Services
                                </h2>

                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Our qualified electricians specialize in electric shower installations and replacements. We work with all major brands and ensure safe, reliable installation.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative h-[600px] rounded-2xl overflow-hidden">
                                    <Image src="/images/services/electric-shower/content.jpg"
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-medium text-blue-600 mb-1">Fast Service</p>
                                                    <h4 className="text-2xl font-bold text-gray-900">Same-Day Available</h4>
                                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                                    ...
                                    <div className="mt-2">
                                        <span className="relative inline-block px-4">
                                            <span className="relative z-10">Shower Fixed?</span>
                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 -rotate-1 rounded"></div>
                                        </span>
                                    </div>
                                </h2>
                                ...
                                <p className="text-xl text-gray-300 mb-8">
                                    Get your electric shower replaced or repaired by certified professionals. Same-day service available for urgent needs.
                                </p>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {[
                                        ...
                                        { text: "Safety Certified", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
                                    ].map((badge, index) => (
