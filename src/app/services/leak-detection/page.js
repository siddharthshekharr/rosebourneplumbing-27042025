        ...
        <div className="min-h-screen">
            ...
            <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                ...
                <div className="absolute inset-0 z-0">
                    <NextImage src="plumbing-website/services/leak-detection/hero"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                            ...
                            <span className="text-sm font-medium text-white">Advanced Detection Technology</span>
                        </div>
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Professional leak detection using state-of-the-art equipment. We locate and fix leaks with minimal disruption to your property.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Suspect a Leak?</h3>
                                    <p className="text-gray-300">Get it checked before it causes damage</p>
                                </div>
                                <Link
                                    href="/contact"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-blue-50">
                                    <span className="text-sm font-medium text-blue-600">Professional Detection</span>
                                </div>
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Using the latest technology and equipment, our expert team can accurately locate leaks without causing unnecessary damage to your property. We provide comprehensive solutions for both visible and hidden leaks.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative h-[600px] rounded-2xl overflow-hidden">
                                    <NextImage src="plumbing-website/services/leak-detection/content"
                                        alt="Leak Detection Services"
                                        fill
                                        className="object-cover"
                                    />
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-medium text-blue-600 mb-1">Advanced Technology</p>
                                                    <h4 className="text-2xl font-bold text-gray-900">99% Detection Rate</h4>
                                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                                    ...
                                    <span className="text-sm font-medium text-blue-100">Expert Detection</span>
                                </div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                                    ...
                                    <div className="mt-2">
                                        <span className="relative inline-block px-4">
                                            <span className="relative z-10">Water Leak?</span>
                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 -rotate-1 rounded"></div>
                                        </span>
                                    </div>
                                </h2>
                                ...
                                <p className="text-xl text-gray-300 mb-8">
                                    Don't let a small leak become a big problem. Our advanced detection technology can find hidden leaks before they cause serious damage.
                                </p>

                                {/* Trust Badges */}
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {[
                                        { text: "Non-Invasive Detection", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
