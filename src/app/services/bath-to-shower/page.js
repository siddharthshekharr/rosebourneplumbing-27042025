        ...
        <div className="min-h-screen">
            ...
            <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                ...
                <div className="absolute inset-0 z-0">
                    <NextImage src="plumbing-website/services/bath-to-shower/hero"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                            ...
                            <span className="text-sm font-medium text-white">Modern Bathroom Solutions</span>
                        </div>
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Transform your outdated bathtub into a modern, accessible shower. Expert conversion service with minimal disruption to your home.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                                <div>
                                    ...
                                    <p className="text-gray-300">Get your free design consultation</p>
                                </div>
                                <Link
                                    href="/contact"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-blue-50">
                                    <span className="text-sm font-medium text-blue-600">Complete Transformation</span>
                                </div>

                                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                                    Expert Bath to Shower Conversion
                                </h2>

                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Our professional team specializes in converting outdated bathtubs into modern, accessible showers. We handle everything from removal to installation, ensuring a seamless transformation.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative h-[600px] rounded-2xl overflow-hidden">
                                    <NextImage src="plumbing-website/services/bath-to-shower/content"
                                        alt="Bath to Shower Conversion"
                                        fill
                                        className="object-cover"
                                    />
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-medium text-blue-600 mb-1">Quick Installation</p>
                                                    <h4 className="text-2xl font-bold text-gray-900">1-2 Days Process</h4>
                                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                                    ...
                                    <span className="text-sm font-medium text-blue-100">Modern Solution</span>
                                </div>
                                ...
                                <p className="text-xl text-gray-300 mb-8">
                                    Convert your outdated bathtub into a modern, accessible shower. Our expert team ensures a quick and professional transformation.
                                </p>

                                {/* Trust Badges */}
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {[
                                        { text: "1-2 Days Installation", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
                                        { text: "Lifetime Warranty", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
                                    ].map((badge, index) => (
