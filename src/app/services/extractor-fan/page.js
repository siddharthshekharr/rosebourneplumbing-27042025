        ...
        <div className="min-h-screen">
            ...
            <section className="relative py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
                ...
                <div className="absolute inset-0 z-0">
                    <NextImage src="plumbing-website/services/extractor-fan/hero"
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Expert extractor fan installation for bathrooms and kitchens. Professional fitting with electrical certification included.
                        </p>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                                <div>
                                    <h3 className="text-xl font-bold text-white mb-2">Need Ventilation?</h3>
                                    <p className="text-gray-300">Professional installation guaranteed</p>
                                </div>
                                <Link
                                    href="/contact"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-blue-50">
                                    <span className="text-sm font-medium text-blue-600">Expert Installation</span>
                                </div>

                                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                                    Professional Extractor Fan Fitting
                                </h2>

                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Our qualified electricians specialize in extractor fan installations. We ensure proper ventilation and electrical safety for your bathroom or kitchen.
                                    </p>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative h-[600px] rounded-2xl overflow-hidden">
                                    <NextImage src="plumbing-website/services/extractor-fan/content"
                                        alt="Extractor Fan Installation"
                                        fill
                                        className="object-cover"
                                    />
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-sm font-medium text-blue-600 mb-1">Certified Installation</p>
                                                    <h4 className="text-2xl font-bold text-gray-900">Safety Guaranteed</h4>
                                                </div>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div>
                                <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-sm mb-6">
                                    ...
                                    <span className="text-sm font-medium text-blue-100">Certified Installation</span>
                                </div>
                                ...
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                                    ...
                                    <div className="mt-2">
                                        <span className="relative inline-block px-4">
                                            <span className="relative z-10">Ventilation</span>
                                            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 -rotate-1 rounded"></div>
                                        </span>
                                    </div>
                                </h2>
                                ...
                                <p className="text-xl text-gray-300 mb-8">
                                    Get your extractor fan installed by certified professionals. Full electrical certification and building regulations compliance.
                                </p>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-8">
                                    {[
                                        ...
                                        { text: "Expert Installation", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
                                    ].map((badge, index) => (
